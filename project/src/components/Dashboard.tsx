...
import { LogOut, FileText, Upload, BarChart3, Clock, User, Search, Calendar, Receipt, Building2, DollarSign, TrendingUp, Home, Briefcase, Award, Trash2, Shield, MessageSquare, Activity } from 'lucide-react';
